class ItemsController < ApplicationController
  ...
  def get_taggable_type(type)
    ...
    def show_on_map
      ...
      @map.icon_global_init( GIcon.new( :image => "/images/map_add.png", :icon_size => GSize.new( 25,25 ), :icon_anchor => GPoint.new(12,10), :info_window_anchor => GPoint.new(9,2) ), "group_icon")
